<div id="header"
    class="flex flex-col lg:flex-row lg:justify-between lg:items-center z-50 max-container lg:padding-container sticky top-0 lg:static pt-4 lg:py-0 lg:mt-3 transition duration-200">
    <div class="flex lg:justify-between items-center gap-4 lg:gap-0 padding-container lg:p-0">
        ...
        <img src="img/logo.png" alt="" class="img-fluid max-h-[35px] lg:max-h-full">
    </div>
    <div class="navbar-content transition-all duration-300 h-0 overflow-hidden padding-container mt-3 border-gray-200 bg-[#151515]">
        {{-- bg-gradient-to-b from-[#151515] from-70% --}}
...
<script>
    ...
    window.addEventListener("scroll", function() {
        ...
        if (window.scrollY > 0) {
            header.classList.add("bg-[#151515]");
        } else {
            header.classList.remove("bg-[#151515]");
        }
    });
