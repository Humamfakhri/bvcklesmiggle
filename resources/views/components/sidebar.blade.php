<div class="sidebar h-screen py-6 bg-dark flex flex-col padding-container sticky top-0">
    ...
    <ul class="flex flex-col gap-5 mt-5 grow">
        ...
        <li><x-nav-link href="/admin/partnership">PARTNERSHIP</x-nav-link></li>
        <li><x-nav-link href="/admin/downloads">DOWNLOADS</x-nav-link></li>
        <li><x-nav-link href="/admin/users">USERS</x-nav-link></li>
