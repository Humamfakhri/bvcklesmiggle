<x-layout>
    ...
    <main class="mb-36">
        <section class="max-container padding-container">
            ...
            <h1 class="font-bold text-gray-200 text-5xl"><span class="color-primary">></span>SHOUT OUT<span
                    class="color-primary">_</span></h1>
            <div class="grid grid-cols-3 gap-4">
                <div class="col-span-2 gap-4">
                    <div class="flex justify-between items-end">
                        <p class="font-semibold text-2xl text-gray-200 max-w-[50%]">We are a<br>creative-smith<br>at the
                ...
                <div class="flex flex-col items-end justify-end gap-10">
                    <p class="text-light text-end text-lg text-gray-200">Our goal is to deliver amazing<br>experiences
                        that
        ...
        <section class="relative max-container mt-10">
            <div class="flex justify-between items-center">
                ...
                <div class="flex flex-col gap-8 padding-container">
                    ...
                    <button
                        class="block ms-auto mt-24 py-5 px-10 bg-primary rounded-lg border-2 border-black shadow-[-6px_6px_rgba(0,0,0,1)] hover:shadow-none hover:-translate-x-1 hover:translate-y-1 transition"><a
        ...
        <section class="mt-5 bg-white">
            ...
            <div class="flex justify-between items-center gap-4 max-container padding-container">
                <div>
                    <h1 class="font-bold text-end text-gray-950 text-5xl"><span class="color-primary">></span>STEP
                        UP<br>YOUR<br>EQUIPMENTS<span class="color-primary">_</span></h1>
                    <button
                        class="block ms-auto mt-10 py-5 px-10 bg-primary rounded-lg border-2 border-black shadow-[-6px_6px_rgba(0,0,0,1)] hover:shadow-none hover:-translate-x-1 hover:translate-y-1 transition"><a
                            href="#" class="font-bold text-2xl text-white">Check Our Inventory!</a></button>
                </div>
                <img src="/img/eqp.png" alt="" class="img-fluid">
                <p class="font-semibold text-2xl text-zinc-500 text-end">Don't
    ...
    <footer class="pt-8 pb-2 max-container padding-container">
        <div class="flex gap-4 items-end justify-end border-y-2 border-gray-200 py-8">
            <p class="font-semibold text-2xl text-gray-200 text-end">Let's make a party,<br>and together, we can conquer
                the world.</p>
            <button
                class="py-5 px-10 bg-primary rounded-lg border-2 border-black shadow-[-6px_6px_rgba(0,0,0,1)] hover:shadow-none hover:-translate-x-1 hover:translate-y-1 transition"><a
                    href="#" class="font-bold text-2xl text-white">Let's make a deal!</a></button>
            <button
                class="pb-2 px-3 bg-[#00ccff] rounded-lg border-2 border-black shadow-[-6px_6px_rgba(0,0,0,1)] hover:shadow-none hover:-translate-x-1 hover:translate-y-1 transition"><a
        ...
        <p class="text-end text-xs text-gray-200 mt-2">COPYRIGHT ©2024<br>BVCKLESMIGGLE, ALL RIGHT RESERVED</p>
    </footer>
</x-layout>
