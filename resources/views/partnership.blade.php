    ...
    <main class="max-container padding-container">
        <section>
            ...
            <div class="lg:grid lg:grid-cols-7 gap-6">
                ...
                <div class="partnershipFeatures {{ $partnerships->count() > 0 ? 'col-span-4' : 'col-span-7' }} gap-4  h-fit">
                    ...
                    <div class="flex flex-col lg:grid lg:grid-cols-2 gap-4 lg:gap-8 mt-6">
                        <div class="flex items-start gap-2">
                            ...
                            <div class="flex flex-col lg:gap-2">
                                ...
                                <p class="text-sm text-gray-200">Fair play, fair pay. When you collaborate with us, it's
                                    all about transparency and mutual gain, because good business is honest business.
                                </p>
                            </div>
                        </div>
                        <div class="flex items-start gap-2">
                            <img src="/img/partnership-double.png" alt=""
                                class="mt-1.5 lg:mt-0 max-w-14 h-auto">
                            <div class="flex flex-col lg:gap-2">
                                <h1 class="font-semibold text-2xl text-gray-200">Double Exposure</h1>
                                <p class="text-sm text-gray-200">Let's turn the spotlight on both sides! Partner with
                                    us, and together we'll amplify our reach, creating a win-win that's louder than
                                    ever.</p>
                            </div>
                        </div>
                    </div>
                    <div class="flex flex-col lg:grid lg:grid-cols-2 gap-4 lg:8 mt-4 lg:mt-6">
                        <div class="flex items-start gap-2">
                            ...
                            <div class="flex flex-col lg:gap-2">
                                ...
                                <p class="text-sm text-gray-200">Crafted for the few, desired by many. Our accessories
                                    are the epitome of exclusivity, available only to those who dare to stand out.</p>
                            </div>
                        </div>
                        <div class="flex items-start gap-2">
                            ...
                            <div class="flex flex-col lg:gap-2">
                                ...
                                <p class="text-sm text-gray-200">So, what's holding you back? The time is now, let's
                                    make something epic together!</p>
                            </div>
                        </div>
                    </div>
                ...
                @if ($partnerships->count() > 0)
                    <div class="col-span-3 flex flex-col mt-10 lg:mt-0">
                        <p class="sponsorsTitle text-end font-semibold text-2xl text-gray-200 pb-2">In they, we trust
                            (each
                            other)</p>
                        <div class="sponsors w-full border-2 border-gray-200 bg-black/50 overflow-y-auto">
                            <div class="grid lg:grid-cols-2 gap-3 p-3">
                                @foreach ($partnerships as $partnership)
                                    <a href="#">
                                        <img src="{{ asset('storage/' . $partnership->image) }}" alt="" class="sponsor-image border-4 border-[#151515] rounded-md">
                                    </a>
                                @endforeach
                                {{-- @for ($i = 0; $i < 12; $i++)
                                <a href="#">
