<x-layout>
    <main class="max-container padding-container">
        <img src="/img/banner_articles_mob.jpg" alt="" class="lg:hidden img-fluid w-full my-2 border-2 border-gray-200">
        <img src="/img/banner_articles.jpg" alt="" class="hidden lg:block img-fluid w-full my-4 border-2 border-gray-200">
        <div class="flex flex-col lg:flex-row gap-4">
            <div class="articles flex flex-col gap-5 lg:gap-7">
                <div class="sticky top-[70px]">
                    <form action="" class="flex items-stretch lg:hidden mb-2">
                ...
                <div class="article px-4 lg:px-10 pt-4 lg:pt-7 pb-4 bg-white rounded-xl grow">
                    ...
                    <p class="article-body leading-relaxed mt-4 lg:mt-7 text-sm lg:text-base line-clamp-3">
                    ...
                    <div class="text-end mt-2">
                        <button>
                            <a href="#" class="text-sm lg:text-base color-primary border border-primary px-2 py-1 rounded-full">Show more</a>
                        </button>
                    </div>
                </div>
                <div class="ads-container flexCenter lg:hidden">
                    {{-- <img src="your-image-url.jpg" alt="336 x 280 (6:5 ratio) Ads Placement" class="ads-image bg-gray-200"> --}}
                    <div class="ads-image ads-1 flexCenter bg-white text-gray-500 text-center text-xs">300 x 250 atau 6:5<br>Ads
                        Placement</div>
                ...
                <div class="article px-4 lg:px-10 pt-4 lg:pt-7 pb-4 bg-white rounded-xl grow">
                    ...
                    <p class="article-body leading-relaxed mt-3 line-clamp-3">
                        Daun-daun bunga krisan jatuhberguguran
                        <br>jatuh ke Jatuh ke bumi mata merah yang dibasahi darah
                        <br>Walaupun demikian, kedudukanmu tetap tidak akan berubah
                        <br>Meski kau kehilangan setengah dari tangan dan kakimu
            ...
            <div class="aside grow">
                ...
                <div class="ads-container mt-4 flexCenter lg:hidden">
                    {{-- <img src="your-image-url.jpg" alt="336 x 280 (6:5 ratio) Ads Placement" class="ads-image bg-gray-200"> --}}
                    <div class="ads-image-s lg:ads-image ads-1 flexCenter bg-white text-gray-500 text-center text-xs">4:3<br>Ads
                        Placement</div>
                </div>
